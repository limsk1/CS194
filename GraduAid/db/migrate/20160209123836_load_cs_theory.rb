class LoadCsTheory < ActiveRecord::Migration
  def up
    theory = Track.new(name: 'CS-Theory')
    theory.save!
    ...
    track_b_list = ['CS167', 'CS168', 'CS255', 'CS261', 'CS264', 'CS265', 'CS268', 'CS361A', 'CS361B']
    ...
    track_c_list = track_b_list + ['CS143', 'CS155', 'CS157', 'CS166', 'CS205A', 'CS228', 'CS233', 'CS242', 'CS254', 'CS259', 'CS262', 'CS263']
    track_c_list += ['CS266', 'CS267', 'CS354', 'CS355', 'CS357', 'CS358', 'CS359', 'CS364A', 'CS364B', 'CS366', 'CS367', 'CS369', 'CS374', 'MS&E310']
    ...
    track_elec_list = track_c_list + ['CME302', 'CME305', 'PHIL152']
