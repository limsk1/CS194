class LoadCsGraphics < ActiveRecord::Migration
  def up
    graphics = Track.new(name: 'CS-Graphics')
    graphics.save!
    ...
    cs_148 = Requirement.new(course_id: Course.find_by(course_name: 'CS148').id, num_courses: 1, priority: 4, repeatable: false)
    cs_148.category = track
    cs_148.save!

    cs_148_ful = Fulfillment.new
    cs_148_ful.requirement = cs_148
    cs_148_ful.course = Course.find_by(course_name: 'CS148')
    cs_148_ful.save!

    cs_248 = Requirement.new(course_id: Course.find_by(course_name: 'CS248').id, num_courses: 1, priority: 4, repeatable: false)
    cs_248.category = track
    cs_248.save!

    cs_248_ful = Fulfillment.new
    cs_248_ful.requirement = cs_248
    cs_248_ful.course = Course.find_by(course_name: 'CS248')
    cs_248_ful.save!
    ...
    track_b_list = ['CS205A', 'CME104', 'CME108', 'MATH52', 'MATH113']
    ...
    track_c_list = ['CS178', 'CS131', 'CS231A', 'CS233', 'CS268', 'CS348A', 'CS348B', 'CS348V', 'CS448']
    ...
    track_elec_list = track_b_list + track_c_list
    track_elec_list += ['ARTSTUDI160', 'ARTSTUDI170', 'ARTSTUDI179', 'CME302', 'CME306', 'EE262', 'EE264', 'EE278', 'EE368', 'ME101', 'PSYCH30', 'PSYCH221']
