class LoadCsInfo < ActiveRecord::Migration
  def up
    ...
    cs_124 = Requirement.new(course_id: Course.find_by(course_name: 'CS124').id, num_courses: 1, priority: 4, repeatable: false)
    cs_124.category = track
    cs_124.save!

    cs_124_ful = Fulfillment.new
    cs_124_ful.requirement = cs_124
    cs_124_ful.course = Course.find_by(course_name: 'CS124')
    cs_124_ful.save!

    cs_145 = Requirement.new(course_id: Course.find_by(course_name: 'CS145').id, num_courses: 1, priority: 4, repeatable: false)
    cs_145.category = track
    cs_145.save!

    cs_145_ful = Fulfillment.new
    cs_145_ful.requirement = cs_145
    cs_145_ful.course = Course.find_by(course_name: 'CS145')
    cs_145_ful.save!
    ...
    track_b_list = ['CS224N', 'CS224S', 'CS229', 'CS229A', 'CS233', 'CS140', 'CS142', 'CS254', 'CS246', 'CS341', 'CS345']
    track_b_list += ['CS346', 'CS347', 'CS262', 'CS270', 'CS274', 'CS224W', 'CS276', 'CS364B']
