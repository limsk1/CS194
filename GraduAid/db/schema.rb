...
ActiveRecord::Schema.define(version: 20160314013834) do

  create_table "ap_credits", force: true do |t|
    t.string   "name"
    t.integer  "grade"
  ...
  add_index "ap_credits", ["user_id"], name: "index_ap_credits_on_user_id"
